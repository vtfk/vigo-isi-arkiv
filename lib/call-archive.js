const { VTFK_ARCHIVE, VFK_ARCHIVE, TFK_ARCHIVE, TFK_COUNTY, VFK_COUNTY, OVERRIDE_TO_VTFK_ARCHIVE } = require('../config')
...
module.exports.callArchive = async (county, endpoint, payload) => {
  ...
  // Midlertidig arkivering til VTFK frem til nyttår, bare å endre i miljøvariabel :)
